...
export declare class AnchorProvider implements Provider {
     ...
     * @param opts          Transaction confirmation options.
     * @note commit #60 change T generic type acceptable type for sendAll trxs in batching procedure.
     */
    sendAll<T extends Transaction | VersionedTransaction | TransactionSignature>(txWithSigners: {
        tx: T;
        signers?: Signer[];
    }[], opts?: ConfirmOptions): Promise<Array<TransactionSignature>>;
    /**
